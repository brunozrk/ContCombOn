    ...
    private Handler handler = new Handler() {
        @Override
         public void handleMessage(Message msg) {
        	...
        	switch (msg.what) {
        		case MSG_SUCCESS_AUTHENTICATE: 	startIndexActivity();
        									   	break;
        		case MSG_FIELD_REQUIRED: 		util.showMessage(getResources().getString(R.string.error), 
        												         getResources().getString(R.string.field_required), 
        												         MainActivity.this); 
        										break;
        		case MSG_ERROR_AUTHENTICATE:    util.showMessage(getResources().getString(R.string.invalid_values), 
        										 			     getResources().getString(R.string.wrong_credentials), 
        													     MainActivity.this); 
        										break;
        		case MSG_WRONG_COFIRM_PASSWORD: util.showMessage(getResources().getString(R.string.invalid_values), 
        														 getResources().getString(R.string.wrong_confirm_password), 
        														 MainActivity.this); 
        										break;
        		case MSG_ERROR: 				util.showMessage(getResources().getString(R.string.error), 
        														 ...
        														 MainActivity.this); 
        										break;  
        		case MSG_CREATE_SUCCESS: 		util.showMessage(getResources().getString(R.string.congrats), 
        														 getResources().getString(R.string.create_success), 
        														 MainActivity.this);
        										loadMainPage();
        										break; 
        		case MSG_INVALID_EMAIL:			util.showMessage(getResources().getString(R.string.invalid_values), 
