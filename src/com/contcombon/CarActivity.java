...
public class CarActivity extends BaseActivity {
  ...
  private Handler handler = new Handler() {
    ...
    public void handleMessage(Message msg) {
      ...
      switch (msg.what) {
        case CREATE_SUCCESS:
          util.showToast(getResources().getString(R.string.create_success), CarActivity.this);
          loadCarListPage();
          enableDrawer();
          break;
        case UPDATE_SUCCESS:
          util.showToast(getResources().getString(R.string.update_success), CarActivity.this);
          loadCarListPage();
          enableDrawer();
          break;
        case MSG_ERROR:
          util.showMessage(getResources().getString(R.string.error), errorMessage, CarActivity.this);
          break;
        case LIST:
        ...
        case EDIT_FORM:
          ...
          break;
        case DELETE_SUCCESS:
          util.showToast(getResources().getString(R.string.delete_success), CarActivity.this);
          loadCarListPage();
          enableDrawer();
          break;
        case AUTOCOMPLETE:
          prepareAutoComplete(models);
          break;
      }
    }
  };
  ...
  public void onLongClickItem() {
    lvCars.setOnItemLongClickListener(new OnItemLongClickListener() {
      ...
      public boolean onItemLongClick(AdapterView<?> arg0, final View view, int position, long id) {
        final int id_car = util.convertStringToInt(list.get(position).get("id"));
        util.confirm(CarActivity.this, getResources().getString(R.string.confirmation), getResources().getString(R.string.delete_confirmation), getResources().getString(R.string.yes), getResources()
