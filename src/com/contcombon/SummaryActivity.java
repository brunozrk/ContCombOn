...
public class SummaryActivity extends BaseActivity {
  ...
  private Handler handler = new Handler() {
    ...
    public void handleMessage(Message msg) {
      ...
      switch (msg.what) {
        case MSG_ERROR:
          util.showMessage(getResources().getString(R.string.error), errorMessage, SummaryActivity.this);
          break;
        case LIST:
  ...
  public void onClickCriterion() {
    ...
    btnCriterion.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View arg0) {
        util.showMessage(getResources().getString(R.string.criterion), getResources().getString(R.string.criterion_description), SummaryActivity.this);
      }
    });
  }
